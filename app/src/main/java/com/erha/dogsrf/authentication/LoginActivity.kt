package com.erha.dogsrf.authentication
...
import com.erha.dogsrf.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    //Propiedades para el usuario y contra
    private var email = ""
        ...
        binding.btnRegistrarse.setOnClickListener {
            ...
            firebaseAuth.createUserWithEmailAndPassword(email, contrasenia).addOnCompleteListener{authResult ->
                if(authResult.isSuccessful){
                    ...
                    //Enviamos correo para verificar el email
    ...
    private fun authenticateUser(usr: String, psw: String){
        ...
        firebaseAuth.signInWithEmailAndPassword(usr, psw).addOnCompleteListener{ authResult ->
            ...
            //Verificamos si fue exitosa la autenticacion
            if(authResult.isSuccessful){
